  ...
  return (
    <div className='user-card'>
      ...
      <section className='user-card__footer'>
        <a href="mailto:aviadchuraman@gmail.com" className='user-card__footer__email'>aviadchuraman@gmail.com</a>
        <p className='user-card__footer__based'>Based in USA</p>
        <a href="https://drive.google.com/file/d/1DJIqYbHZUKw-Mbj2PTeMoA4-OgDNCLAn/view?usp=sharing" className='user-card__footer__resume'>Resume</a>
